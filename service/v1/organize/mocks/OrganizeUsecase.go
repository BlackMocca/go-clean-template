...
// OrganizeUsecase is an autogenerated mock type for the OrganizeUsecase type
type OrganizeUsecase struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, _a1
func (_m *OrganizeUsecase) Create(ctx context.Context, _a1 *models.Organize) error {
...
func (_m *OrganizeUsecase) FetchAll(ctx context.Context, args *sync.Map, paginator *backendmodels.Paginator) ([]*models.Organize, error) {
...
func (_m *OrganizeUsecase) FetchOneById(ctx context.Context, orgId *uuid.UUID) (*models.Organize, error) {
...
type mockConstructorTestingTNewOrganizeUsecase interface {
	mock.TestingT
	Cleanup(func())
}

// NewOrganizeUsecase creates a new instance of OrganizeUsecase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewOrganizeUsecase(t mockConstructorTestingTNewOrganizeUsecase) *OrganizeUsecase {
	mock := &OrganizeUsecase{}
	mock.Mock.Test(t)
